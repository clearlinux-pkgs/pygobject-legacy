...
Requires: pygobject-legacy-lib = %{version}-%{release}
Requires: pygobject-legacy-license = %{version}-%{release}
Requires: pygobject-legacy-python = %{version}-%{release}
...
%description bin
bin components for the pygobject-legacy package.


%package data
Summary: data components for the pygobject-legacy package.
Group: Data

%description data
data components for the pygobject-legacy package.


%package dev
Summary: dev components for the pygobject-legacy package.
Group: Development
Requires: pygobject-legacy-lib = %{version}-%{release}
Requires: pygobject-legacy-bin = %{version}-%{release}
Requires: pygobject-legacy-data = %{version}-%{release}
...
%package doc
Summary: doc components for the pygobject-legacy package.
Group: Documentation

%description doc
doc components for the pygobject-legacy package.


%package legacypython
Summary: legacypython components for the pygobject-legacy package.
Group: Default
Requires: python-core

%description legacypython
legacypython components for the pygobject-legacy package.


%package lib
Summary: lib components for the pygobject-legacy package.
Group: Libraries
Requires: pygobject-legacy-data = %{version}-%{release}
Requires: pygobject-legacy-license = %{version}-%{release}

%description lib
lib components for the pygobject-legacy package.


%package license
Summary: license components for the pygobject-legacy package.
Group: Default

%description license
license components for the pygobject-legacy package.


%package python
Summary: python components for the pygobject-legacy package.
Group: Default

%description python
python components for the pygobject-legacy package.


%prep
%setup -q -n pygobject-2.28.7
...
%files data
%defattr(-,root,root,-)
/usr/share/pygobject/2.0/codegen/__init__.py
/usr/share/pygobject/2.0/codegen/__init__.pyc
/usr/share/pygobject/2.0/codegen/argtypes.py
/usr/share/pygobject/2.0/codegen/argtypes.pyc
...
/usr/share/pygobject/2.0/codegen/definitions.py
/usr/share/pygobject/2.0/codegen/definitions.pyc
/usr/share/pygobject/2.0/codegen/defsconvert.py
/usr/share/pygobject/2.0/codegen/defsgen.py
/usr/share/pygobject/2.0/codegen/defsparser.py
/usr/share/pygobject/2.0/codegen/defsparser.pyc
/usr/share/pygobject/2.0/codegen/docextract.py
/usr/share/pygobject/2.0/codegen/docextract.pyc
/usr/share/pygobject/2.0/codegen/docextract_to_xml.py
/usr/share/pygobject/2.0/codegen/docgen.py
/usr/share/pygobject/2.0/codegen/h2def.py
/usr/share/pygobject/2.0/codegen/mergedefs.py
/usr/share/pygobject/2.0/codegen/missingdefs.py
/usr/share/pygobject/2.0/codegen/mkskel.py
/usr/share/pygobject/2.0/codegen/override.py
/usr/share/pygobject/2.0/codegen/override.pyc
/usr/share/pygobject/2.0/codegen/reversewrapper.py
/usr/share/pygobject/2.0/codegen/reversewrapper.pyc
/usr/share/pygobject/2.0/codegen/scanvirtuals.py
/usr/share/pygobject/2.0/codegen/scmexpr.py
...
/usr/lib64/libpyglib-2.0-python2.so
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libpyglib-2.0-python2.so.0
/usr/lib64/libpyglib-2.0-python2.so.0.0.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/pygobject-legacy/COPYING
